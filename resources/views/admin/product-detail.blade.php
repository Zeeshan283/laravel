...
<head>
    ...
    <!-- owlcarousel css-->
    <link rel="stylesheet" type="text/css" href="../assets/admin/css/owlcarousel.css">

    <!-- Rating css-->
    <link rel="stylesheet" type="text/css" href="../assets/admin/css/rating.css">
...
<div class="page-wrapper">
    ...
    <div class="page-main-header">
        <div class="main-header-left">
            <div class="logo-wrapper"><a href="{{ route('admin')}}"><h3>Menu</h3></a></div>
        </div>
                    ...
                    <div class="row product-page-main card-body">
                        <div class="col-xl-4">
                            <div class="product-slider owl-carousel owl-theme" id="sync1">
                                <div class="item"><img src="../assets/admin/images/pro3/2.jpg" alt="" class="blur-up lazyloaded"></div>
                                <div class="item"><img src="../assets/admin/images/pro3/27.jpg" alt="" class="blur-up lazyloaded"></div>
                                <div class="item"><img src="../assets/admin/images/pro3/1.jpg" alt="" class="blur-up lazyloaded"></div>
                                <div class="item"><img src="../assets/admin/images/pro3/27.jpg" alt="" class="blur-up lazyloaded"></div>
                                <div class="item"><img src="../assets/admin/images/pro3/2.jpg" alt="" class="blur-up lazyloaded"></div>
                                <div class="item"><img src="../assets/admin/images/pro3/1.jpg" alt="" class="blur-up lazyloaded"></div>
                                <div class="item"><img src="../assets/admin/images/pro3/27.jpg" alt="" class="blur-up lazyloaded"></div>
                                      ...
                                      <div class="modal fade" id="sizemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body"><img src="../assets/admin/images/size-chart.jpg" alt="" class="img-fluid "></div>
                                          </div>
                                        </div>
                                      </div>
...
<!-- Rating Js-->
<script src="../assets/admin/js/rating/jquery.barrating.js"></script>
<script src="../assets/admin/js/rating/rating-script.js"></script>

<!-- Owlcarousel js-->
<script src="../assets/admin/js/owlcarousel/owl.carousel.js"></script>
<script src="../assets/admin/js/dashboard/product-carousel.js"></script>

<!--Customizer admin-->
<script src="../assets/admin/js/admin-customizer.js"></script>

<!-- timer js -->
<script src="../assets/admin/js/timer1.js"></script>
