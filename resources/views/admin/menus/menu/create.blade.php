...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/website-assets/css/toastr.min.css') }}">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('menus.store') }}"  enctype="multipart/form-data" class="needs-validation">
                                    @csrf
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            <input class="form-control" name="name" id="validationCustom0" type="text" >     
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                        <input type="text" name="icon" class="form-control iconpicker" placeholder="Select Icon" aria-label="Icone Picker"
