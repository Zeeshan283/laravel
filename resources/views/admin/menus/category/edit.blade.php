                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                    <form method="POST" action="{{ route('categories.update', ['category' => $data->id]) }}"  enctype="multipart/form-data" class="needs-validation">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-2">
                                            <label for="validationCustom0" ><span>*</span>Select Menu</label>    
                                        </div>
                                        <div class="col-md-3">
                                            <select class="form-control" id="validationCustom0" name="menu_id">
                                                <option value="{{ $data->menus->id }}" selected>{{ $data->menus->name }}</option>
                                        ...
                                        <div class="col-md-3">
                                            <input class="form-control" value="{{ $data->name }}" name="name" id="validationCustom0" type="text" required="">     
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-2">
                                            <label for="validationCustom0" ><span>*</span>Category Image (Dim: 300 x 300)</label>    
                                        </div>
                                        <div class="col-md-3">
                                            <input class="form-control" name="img" id="imageshow" id="" type="file" >     
                                        
                                        </div>

                                        <div class="col-xl-3 col-md-2">
                                            <label for="validationCustom0" ><span>*</span>Category ImageForApp</label>    
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-2">
                                            <label for="validationCustom0" ><span>*</span>Category Side Slider's (Dim: 299 x 400)</label>    
                                        </div>
                                        <div class="col-md-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                        <img src="{{ asset($data->img) }}"  class="img-fluid" id="show_image" width="150" >
                                        ...
                                        <div class="col-md-3">
                                        <img src="{{ asset($data->imageforapp) }}"  class="img-fluid" id="show_image1" width="150" >
                                        ...
                                        <div class="form-group row mt-5">
                                        <div class="col-xl-3 col-md-2">
                                            <label for="validationCustom0" ><span>*</span>Side Slider (Dim: 299 x 400)</label>    
                                        </div>
                                        <div class="col-md-9">
                                        <div class="input-right-icon">
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    ...
    headers: {
        ...
        $('.delete-image').on('click', function () {
            ...
            $.ajax({
                type: 'DELETE',
                url: '/categories/' + categoryId + '/delete-image/' + imageId,
        ...
        $('.delete-slider').on('click', function () {
            ...
            $.ajax({
                type: 'DELETE',
                url: '/categoriesslider/' + categoryId + '/delete-image/' + imageId,
                success: function (response) {
                    // Handle success (e.g., remove the image from the DOM)
                    if (response.success) {
                        $('.image-item[data-image-id="' + imageId + '"]').remove();
