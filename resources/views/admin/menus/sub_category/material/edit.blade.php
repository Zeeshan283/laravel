                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" method="POST"  action="{{ route('materials.update', ['material' => $edit->id]) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            <input class="form-control" name="name" value="{{ $edit->name }}" id="validationCustom0" Material="text" required>     
                                        </div>
