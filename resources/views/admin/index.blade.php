                ...
                <div class="p-l-30 p-r-30">
                    <div class="chat-box">
                        <div class="people-list friend-list">
                            <ul class="list">
                                <li class="clearfix"><img class="rounded-circle user-image" src="../assets/admin/images/dashboard/user.png" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="../assets/admin/images/dashboard/user1.jpg" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="../assets/admin/images/dashboard/user2.jpg" alt="">
                                    <div class="status-circle online"></div>
                                    <div class="about">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="../assets/admin/images/dashboard/user3.jpg" alt="">
                                    <div class="status-circle online"></div>
                                    <div class="about">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="../assets/admin/images/dashboard/man.png" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="../assets/admin/images/dashboard/user5.jpg" alt="">
                                    <div class="status-circle away"></div>
                                    <div class="about">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="../assets/admin/images/dashboard/designer.jpg" alt="">
                                    <div class="status-circle online"></div>
                                    <div class="about">
                                    ...
                                    <table class="table table-bordernone mb-0">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="../assets/admin/images/dashboard/user2.jpg" alt="" data-original-title="" title="">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="../assets/admin/images/dashboard/man.png" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="../assets/admin/images/dashboard/user.png" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="../assets/admin/images/dashboard/designer.jpg" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
