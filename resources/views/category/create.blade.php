                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                    <form method="POST" action="{{ route('categories.store') }}"  enctype="multipart/form-data" class="needs-validation">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-3 col-md-2">
                                            <label for="validationCustom0" ><span>*</span>Category IFA </label>    
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-3 col-md-2">
                                            <label for="validationCustom0" ><span>*</span>Category Image</label>    
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class=" col-md-3">
                                            <div class="checkbox checkbox-primary ">
                                                <input id="checkbox-primary-2" type="checkbox" selected  data-original-title="" title="">
