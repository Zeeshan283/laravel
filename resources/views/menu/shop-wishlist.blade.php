							...
							<table class="table check-tbl table-responsive-md">
								...
								<tbody>
									<tr>
										...
										<td class="product-item-name">Cheese Pizza</td>
										<td class="product-item-price">$35.00</td>
										<td class="product-item-totle"><a href="shop-cart.html" class="btn btn-gray btn-hover-2">Add To Cart</a></td>
									...
									<tr>
										...
										<td class="product-item-name">Fried Rice</td>
									...
									<tr>
										...
										<td class="product-item-name">Green Salad</td>
										<td class="product-item-price">$15.00</td>
										<td class="product-item-totle"><a href="shop-cart.html" class="btn btn-gray btn-hover-2">Add To Cart</a></td>
										<td class="product-item-close">
											<a href="javascript:void(0);" class="bg-danger">
												<i class="fa fa-close"></i>
									...
									<tr>
										...
										<td class="product-item-name">Butterfly Pasta</td>
										<td class="product-item-price">$55.00</td>
										<td class="product-item-totle"><a href="shop-cart.html" class="btn btn-gray btn-hover-2">Add To Cart</a></td>
										<td class="product-item-close">
											<a href="javascript:void(0);" class="bg-danger">
												<i class="fa fa-close"></i>
