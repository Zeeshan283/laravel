			...
			<div class="container">
				<nav aria-label="breadcrumb" class="breadcrumb-row">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Blog Open Gutenberg</li>
					</ul>
				</nav>
			</div>
		</div>
			...
			<div class="min-container">
				...
				<div class="blog-single dz-card">
					<div class="post-header">
						<h1 class="dz-title">Uncovering Taste of Tradition & Celebrating Timeless Recipes</h1>
						<div class="dz-meta">
							<ul>
					...
					<div class="dz-media alignfullwide">
						<img src="assets/images/background/pic20.png" alt="/">
					</div>
					<div class="dz-info">
						<div class="dz-post-text">
							...
							<figure class="wp-container-5 wp-block-gallery-3 wp-block-gallery has-nested-images columns-3 is-cropped alignwide">
								<figure class="wp-block-image size-large"><img src="assets/images/blog/detail/pic3.jpg" alt="/"></figure>
								<figure class="wp-block-image size-large"><img src="assets/images/blog/detail/pic4.jpg" alt="/"></figure>
								<figure class="wp-block-image size-large"><img src="assets/images/blog/detail/pic5.jpg" alt="/"></figure>
								<figure class="wp-block-image size-large"><img src="assets/images/blog/detail/pic6.jpg" alt="/"></figure>
								<figure class="wp-block-image size-large"><img src="assets/images/blog/detail/pic7.jpg" alt="/"></figure>
							</figure>
							<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
							
							<div class="alignfullwide">
								<img src="assets/images/background/pic21.png" alt="/">
							</div>
							
							<p>It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. </p>
							<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
							
							<div class="author-box m-b30">
								<div class="author-profile-info">
									<div class="author-profile-pic">
										<img src="assets/images/blog/detail/author.jpg" alt="/">
									</div>
									<div class="author-profile-content">
										<h6>I am John Doe</h6>
										<p>I am a Senior Chief in London</p>
										<img src="assets/images/blog/detail/signing.png" alt="/">
