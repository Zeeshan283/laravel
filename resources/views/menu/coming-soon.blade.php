...
<!-- Mirrored from swigo.dexignzone.com/xhtml/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Sep 2023 18:07:54 GMT -->
<head>
...
<div class="page-wraper">
	...
	<div class="page-content bg-white">
		<div class="coming-wrapper overflow-hidden">
			<div class="container">
				<img class="bg-img dz-move" src="assets/images/background/pic17.png" alt="/">
				<div class="row">
					<div class="col-lg-8 m-auto">
						<div class="inner-content text-center">
							<div class="logo-header">
								<a href="index.html" class="logo logo-dark anim-logo"><img src="assets/images/logo.png" alt="/"></a>
							</div>
							<h3 class="coming-head">WE ARE COMING SOON!</h3>
							<p class="coming-para">Stay tuned for something amazing</p>
							<lottie-player src="assets/json/coming-soon.json" class="coming-media" background="transparent.html" speed="1" loop autoplay></lottie-player>
						</div>
						<div class="middle-content">
							<h5 class="font-weight-400 m-b20">Subscribe to our mailing list to get latest updates</h5>
							<form class="dzSubscribe m-b15" action="https://swigo.dexignzone.com/xhtml/assets/script/mailchamp.php" method="post">
								<div class="dzSubscribeMsg text-white"></div>
								<div class="input-group">
									<input name="dzEmail" required="required" type="text" class="form-control bg-grey" placeholder="Enter Your Email">
							...
							<div class="dz-social-icon text-center">
								<ul>
									<li><a target="_blank" class="text-dark" href="https://www.facebook.com/">
										<i class="fab fa-facebook-f"></i>
									</a></li>
									<li><a target="_blank" class="text-dark" href="https://twitter.com/">	
										<i class="fab fa-twitter"></i>
									</a></li>
									<li><a target="_blank" class="text-dark" href="https://www.youtube.com/">
										<i class="fa-brands fa-youtube"></i>
									</a></li>
									<li><a target="_blank" class="text-dark" href="https://www.instagram.com/">
										<i class="fab fa-instagram"></i>
									</a></li>
									<li><a target="_blank" class="text-dark" href="https://www.linkedin.com/">
...
<script src="../../unpkg.com/%40lottiefiles/lottie-player%402.0.2/dist/lottie-player.js"></script><!-- LOTTIE PLAYER -->
...
<!-- Mirrored from swigo.dexignzone.com/xhtml/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Sep 2023 18:07:59 GMT -->
</html>