				...
				<div class="row">
					...
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="dz-team style-1">
							...
							<div class="dz-content">
								<div class="clearfix">
									<h6 class="dz-name"><a href="team-detail.html">Stevin Mark</a></h6>
									<span class="dz-position">Senior Chef</span>
								</div>
								<ul class="team-social">
									<li>
					...
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="dz-team style-1">
							...
							<div class="dz-content">
								<div>
									<h5 class="dz-name"><a href="team-detail.html">John Doe</a></h5>
									<span class="dz-position">Senior Chef</span>
								</div>
								<ul class="team-social">
									<li>
					...
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="dz-team style-1">
							...
							<div class="dz-content">
								<div>
									<h5 class="dz-name"><a href="team-detail.html">Raiyan Kovin</a></h5>
									<span class="dz-position">Senior Chef</span>
								</div>
								<ul class="team-social">
									<li>
					...
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="dz-team style-1">
							...
							<div class="dz-content">
								<div>
									<h5 class="dz-name"><a href="team-detail.html">Jemy Carline</a></h5>
									<span class="dz-position">Senior Chef</span>
								</div>
								<ul class="team-social">
									<li>
					...
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="dz-team style-1">
							...
							<div class="dz-content">
								<div>
									<h5 class="dz-name"><a href="team-detail.html">Martin Doe</a></h5>
									<span class="dz-position">Senior Chef</span>
								</div>
								<ul class="team-social">
									<li>
					...
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="dz-team style-1">
							...
							<div class="dz-content">
								<div>
									<h5 class="dz-name"><a href="team-detail.html">Stevin Mark</a></h5>
									<span class="dz-position">Senior Chef</span>
								</div>
								<ul class="team-social">
									<li>
