		...
		<div class="dz-bnr-inr style-1 text-center bg-parallax" style="background-image:url('assets/images/banner/bnr1.jpg'); background-size:cover; background-position:center;">
			<div class="container">
				<div class="dz-bnr-inr-entry">
					<h1>Blog Grid 3 Masonry</h1>
					<!-- Breadcrumb Row -->
					<nav aria-label="breadcrumb" class="breadcrumb-row">
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="index.html">Home</a></li>
							<li class="breadcrumb-item active" aria-current="page">Blog Grid 3 Masonry</li>
						</ul>
					</nav>
					<!-- Breadcrumb Row End -->
				</div>
		...
		<section class="content-inner">
			<div class="container clearfix">
				<div id="masonry" class="row" data-masonry='{"percentPosition": true}'>
					...
					<div class="card-container col-lg-4 col-md-6">
						<div class="dz-card style-1 m-b30">
							<div class="service2-swiper swiper">
								<div class="swiper-wrapper">
									<div class="swiper-slide"><img src="assets/images/blog/grid3/pic1.jpg" alt=""></div>
									<div class="swiper-slide"><img src="assets/images/blog/grid3/pic2.jpg" alt=""></div>
									<div class="swiper-slide"><img src="assets/images/blog/grid3/pic3.jpg" alt=""></div>
								</div>
					...
					<div class="card-container col-lg-4 col-md-6">
						<div class="dz-card style-3 m-b30" style="background-image: url(assets/images/blog/large/pic1.jpg)">
							<div class="dz-info">
								<h4 class="dz-title"><a href="blog-standard.html" class="text-white">Exploring the World of Pizza</a></h4>
								<div class="dz-meta">
									<ul>
					...
					<div class="card-container col-lg-4 col-md-6">
						<blockquote class="wp-block-quote mt-0 m-b30">
							<p>Create An Information That’s Easy To Use Usability Considerations For Partially</p>
					...
					<div class="card-container col-lg-4 col-md-6">
						<div class="dz-card style-1 m-b30">
							<div class="service-swiper swiper">
								<div class="swiper-wrapper">
									<div class="swiper-slide"><img src="assets/images/blog/grid3/pic1.jpg" alt=""></div>
									<div class="swiper-slide"><img src="assets/images/blog/grid3/pic4.jpg" alt=""></div>
									<div class="swiper-slide"><img src="assets/images/blog/grid3/pic3.jpg" alt=""></div>
								</div>
								<div class="swiper-pagination style-1"></div>
								<div class="service-button-prev btn-prev rounded-xl"><i class="icon-arrow-left"></i></div>
								<div class="service-button-next btn-next rounded-xl"><i class="icon-arrow-right"></i></div>
							</div>
							<div class="dz-info">
								<div class="dz-meta">
									<ul>
					...
					<div class="card-container col-lg-4 col-md-6">
						<div class="dz-card style-1 overlay-shine dz-img-effect zoom m-b30">
							...
							<div class="dz-info">
								...
								<h5 class="dz-title"><a href="blog-standard.html">Enchanting Dishes That Will Transport You to Food Heaven</a></h5>
								<p>There are many variations of passages of Lorem Ipsum available, but the majority have. </p>
								<a href="blog-standard.html" class="btn btn-primary btn-hover-2">Read More</a>
							</div>
						</div>
					...
					<div class="card-container col-lg-4 col-md-6">
						<div class="dz-card style-1 m-b30">
							<div class="post-swiper swiper">
								<div class="swiper-wrapper">
									<div class="swiper-slide"><img src="assets/images/blog/grid3/pic5.jpg" alt=""></div>
									<div class="swiper-slide"><img src="assets/images/blog/grid3/pic4.jpg" alt=""></div>
									<div class="swiper-slide"><img src="assets/images/blog/grid3/pic6.jpg" alt=""></div>
								</div>
								<div class="menu-button-prev btn-prev rounded-xl"><i class="icon-arrow-left"></i></div>
								<div class="menu-button-next btn-next rounded-xl"><i class="icon-arrow-right"></i></div>
							</div>
							<div class="dz-info">
								<div class="dz-meta">
									<ul>
					...
					<div class="card-container col-lg-4 col-md-6">
						<div class="dz-card style-1 m-b30">
							<div class="dz-media w-100">
								<a href="blog-standard.html"><img src="assets/images/blog/grid3/pic1.jpg" alt="/"></a>
								<a class="video style-1 video-btn popup-youtube" href="https://www.youtube.com/watch?v=XJb1G9iRoL4">
					...
					<div class="card-container col-lg-4 col-md-6">
						<div class="dz-card style-2 overlay-shine dz-img-effect zoom m-b30">
							<div class="dz-media">
								<a href="blog-standard.html"><img src="assets/images/blog/grid3/pic2.jpg" alt="/"></a>
							</div>
							<div class="dz-info bg-white">
								<h5 class="dz-title"><a href="blog-standard.html">Taste Excitement</a></h5>
								<div class="dz-meta">
									<ul>
										<li class="dz-user">
											<a href="javascript:void(0);"><i class="fa-solid fa-user"></i>
								...
								<p class="mb-0">Nostrud tem exrcitation duis laboris nisi ut aliquip sed duis aute cupidata.</p>
							</div>
						</div>
					</div>
				</div>
