		...
		<div class="dz-bnr-inr style-1 text-center bg-parallax" style="background-image:url('assets/images/banner/bnr5.jpg'); background-size:cover; background-position:center;">
			<div class="container">
				<div class="dz-bnr-inr-entry">
					<h1>Blog Grid 4 Masonry</h1>
					<!-- Breadcrumb Row -->
					<nav aria-label="breadcrumb" class="breadcrumb-row">
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="index.html">Home</a></li>
							<li class="breadcrumb-item active" aria-current="page">Blog Grid 4 Masonry</li>
						</ul>
					</nav>
					<!-- Breadcrumb Row End -->
				</div>
		...
		<section class="content-inner">
			<div class="container-fluid clearfix">
				<div id="masonry" class="row" data-masonry='{"percentPosition": true}'>
					<div class="card-container col-xl-3 col-lg-4 col-md-6">
					...
					<div class="card-container col-xl-3 col-lg-4 col-md-6">
						<div class="dz-card style-3 m-b30" style="background-image: url(assets/images/blog/large/pic1.jpg)">
							<div class="dz-info">
								<h4 class="dz-title"><a href="blog-standard.html" class="text-white">Exploring Pizza</a></h4>
								<div class="dz-meta">
									<ul>
										<li class="dz-date">
											<a href="javascript:void(0);">14 Feb 2023</a>
										</li>
										<li class="dz-user">
					...
					<div class="card-container col-xl-3 col-lg-4 col-md-6">
						<div class="dz-card style-2 overlay-shine dz-img-effect zoom m-b30">
							...
							<div class="dz-info bg-white">
								<h5 class="dz-title"><a href="blog-standard.html">Amazing Taste</a></h5>
								<div class="dz-meta">
									<ul>
										<li class="dz-user">
											<a href="javascript:void(0);"><i class="fa-solid fa-user"></i>
