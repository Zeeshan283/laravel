...
<head>
    ...
    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="../assets/admin/css/icofont.css">

    <!-- Prism css-->
    <link rel="stylesheet" type="text/css" href="../assets/admin/css/prism.css">

    <!-- Chartist css -->
    <link rel="stylesheet" type="text/css" href="../assets/admin/css/chartist.css">
...
<div class="page-wrapper">
    ...
    <div class="page-main-header">
        <div class="main-header-left">
            {{-- <div class="logo-wrapper"><a href="{{ route('admin')}}"><img class="blur-up lazyloaded" src="../assets/admin/images/layout-2/logo/logo.png" alt=""></a></div> --}}
            <div class="logo-wrapper"><a href="{{ route('admin')}}"><h2> Menus </h2></a></div>
        </div>
                ...
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown">
                        ...
                        <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                            ...
                            {{-- logout  --}}
                            <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout<span class="pull-right"></span></a></li>
